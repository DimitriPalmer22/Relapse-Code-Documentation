...
| Power Logic Prefab               | A prefab that contains the actual logic for how the power works. A power without this won't do anything / will cause ERRORS.<br><br>Make sure that the prefab has one of the correct power scripts on it!<br><br>The power scripts are found ing                                                                                                                                                                                                   |
