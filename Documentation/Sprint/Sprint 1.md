...
3.	Players enter the 5th floor from the top staircase of the level. As the player enters the 5 As the player advances, debris and enemies block the hallways. Certain rooms have broken walls to help navigate the player around blocked debris. In some rooms, players can discover lore items, giving more narrative for the player. In the top-right corner, players discover a weapon upgrade in the hidden room. A unique interaction involving an enemy falling out the door is in the janitor’s closet. Inside the janitor’s closet is a key allowing players to access the admin elevator, which acts like a shortcut to descend to the lobby faster. Towards the far bottom-left corner, players encounter the dealer, who provides items for players to purchase. 
