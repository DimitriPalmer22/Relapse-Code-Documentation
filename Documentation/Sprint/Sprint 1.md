...
3.	Players enter the 5th floor from the top staircase of the level. As the player enters the 5th floor, they go to the left, progressing through the room with the hole in the wall. From the green exit sign the player sees once they get out of the room, the player needs to move forward until they reach the 2nd right turn. The player nee  
