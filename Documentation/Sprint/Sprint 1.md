...
3.	Players enter the 5th floor from the top staircase of the level that leads to the 4th floor. As the player advances, debris and enemies block the hallways. Certain rooms have broken walls to help navigate the player around blocked debris. In some rooms, players can discover lore items, giving more narrative for the player. In the top-right corner, players discover a weapon upgrade in the hidden room. A unique interaction involving an enemy falling out the door is in the janitor’s closet. Inside the janitor’s closet is a key allowing players to access the admin elevator, which acts like a shortcut to descend to the lobby faster. Towards the far bottom-left corner, players encounter the dealer, who provides items for players to purchase. 
4.	After exploring the floor, players locate the escalator and use the hatch to descend back to the lower floors. The open elevator descends to the 3rd floor. After gaining access, the admin elevator descends the player to the 2nd floor. If players refuse to take the elevator, they can descend the 3rd floor via the other staircase.
