...
10. The player exits the stairwell and eventually ends up in a "mindbreak" area. The first section of this area is a simple jumping puzzle. Once the player completes this, they walk \up a set of stairs and enter a tutorial for wall running. Next, the player needs to run along the various bright walls to get to the end of the mindbreak area. Once the player reaches the very large orb at the bottom of the large slope, they will have completed the apartment level
